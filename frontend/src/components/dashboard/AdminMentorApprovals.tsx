...
export function AdminMentorApprovals() {
  ...
  return (
    <div className="space-y-8">
      ...
      {rejectId ? (
        <form onSubmit={submitReject} className="rounded-md border border-slate-200 bg-white p-5 dark:border-slate-700 ">
...
function MentorReviewCard({
  ...
  return (
    <article className="rounded-md border border-slate-200/90 bg-white p-5 shadow-none dark:border-slate-700 ">
