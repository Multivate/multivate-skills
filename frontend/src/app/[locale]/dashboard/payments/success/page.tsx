  ...
  if (checking) {
    return (
      <div className="mx-auto max-w-lg text-center">
        <div className="rounded-md border border-neutral-200/90 bg-brand-surface p-10 shadow-none">
          <Loader2 className="mx-auto h-12 w-12 animate-spin text-brand-accent" />
          <h1 className="mt-4 text-xl font-semibold text-brand-ink">{t("checkingTitle")}</h1>
          <p className="mt-3 text-sm leading-relaxed text-neutral-500">{t("checkingBody")}</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="mx-auto max-w-lg text-center">
        <div className="rounded-md border border-amber-200/90 bg-amber-50/80 p-10 shadow-none">
          <h1 className="text-xl font-semibold text-brand-ink">{t("pendingTitle")}</h1>
          <p className="mt-3 text-sm leading-relaxed text-zinc-700">{t("pendingBody")}</p>
  ...
  return (
    <div className="mx-auto max-w-lg text-center">
      <div className="rounded-md border border-emerald-200/90 bg-emerald-50/80 p-10 shadow-none dark:border-emerald-900/40 dark:bg-emerald-950/30">
        ...
        <h1 className="mt-4 text-2xl font-semibold text-brand-ink">{t("title")}</h1>
        <p className="mt-3 text-sm leading-relaxed text-zinc-700">{t("body")}</p>
        <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center">
          ...
          <Link
            ...
            className="rounded-md border border-brand-secondary/30 px-6 py-2.5 text-sm font-semibold text-brand-secondary transition hover:bg-brand-secondary/10"
          >
            {t("payments")}
          </Link>
        </div>
